...
RELEASE_BASE="https://github.com/Anthropic-CN/claude/releases/download"
...
manifest_json=$(download_file "$RELEASE_BASE/$version/manifest.json")
...
if ! download_file "$RELEASE_BASE/$version/claude-$platform" "$binary_path"; then
